...
namespace Unlimited_NetworkingServer_MiningGame.Login
{
    ...
    internal static class Encryption
    {
        ...
        private static void FromXmlString(this RSACryptoServiceProvider rsa, string xmlString)
        {
        ...
        private static string ToXmlString(this RSACryptoServiceProvider rsa)
        {
